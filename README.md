...
Node版とlite版の入力画面には、HTML保存ブックマークレットをコピーするボタンがあります。コピーした内容をブラウザのブックマークURLに登録し、ニコニ貢献のcontents/rewardページで実行すると、入力用HTMLを保存できます。ブックマークレットは現在の表示分を保存する通常版と、一番下まで自動スクロールしてから保存する版を選べます。
